...
class TelaVerCliente extends StatefulWidget {
  final int idCliente;
  const TelaVerCliente({super.key, required this.idCliente});

  @override
  State<TelaVerCliente> createState() => _TelaVerClienteState();
}

class _TelaVerClienteState extends State<TelaVerCliente> {
